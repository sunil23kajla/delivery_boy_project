    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              "Tracking: #${controller.shipment['tracking_id'] ?? 'SK45621'}",
            ...
            Text(
              "Order: #${controller.shipment['order_id'] ?? 'ORD-001'}",
              style: const TextStyle(
          ...
          children: [
                ...
                children: [
                      ...
                      Row(
                        children: [
                          _IconButton(
                            icon: Icons.phone,
                            color: Colors.green,
                            onTap: () => ExternalActions.makeCall(
                                controller.shipment['phone'] ?? ''),
                          ),
                          const SizedBox(width: 10),
                          _IconButton(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          controller.shipment['address'] ??
                              '123, Street Name, City, State, 110001',
                          style: const TextStyle(
            ...
            Container(
              ...
              child: Builder(builder: (context) {
                final items = controller.shipment['items'];
            ...
            // Payment Status — only shown for COD
            if ((controller.shipment['type'] ?? 'COD') == 'COD') ...[
              Center(
                child: Column(
                  children: [
                    Text(
              ...
              children: [
                ...
                CustomButton(
                  ...
                  onPressed: () {
                    Get.back();
                    Get.snackbar(
                        AppStrings.success, AppStrings.paymentCollectedSuccess);
                  },
                ),
              ],
            ),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(AppStrings.paymentPending,
                  style: const TextStyle(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(
                        child: Text(AppStrings.recountCashInfo,
                            style:
              ...
              ListTile(
                ...
                title: Text(AppStrings.tryAnotherPayment,
              ...
              CustomButton(
                ...
                onPressed: () {
                  Get.back();
                  Get.snackbar(
                      AppStrings.success, AppStrings.cashCollectedSuccess);
                },
              ),
              const SizedBox(height: 20),
            ],
