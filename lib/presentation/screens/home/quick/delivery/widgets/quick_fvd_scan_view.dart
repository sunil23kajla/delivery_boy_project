...
class DeliveryScanView extends GetView<QuickFlowController> {
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => Container(
                      ...
                      child: controller.isFvdCameraActive.value
                          ? Stack(
                              alignment: Alignment.center,
                              children: [
                                MobileScanner(
                                  controller: controller.fvdScanController,
                                  onDetect: (capture) {
                                    ...
                                    if (barcodes.isNotEmpty) {
                                      ...
                                      if (code.isNotEmpty) {
                                        controller.completeFvdScan(code);
                                        controller.isFvdCameraActive.value = false;
                                      }
                                    }
                                  },
                                ),
                          ...
                          : Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: controller.toggleFvdCamera,
                ...
                SizedBox(
                  width: double.infinity,
                  child: TextButton(
                    onPressed: controller.skipFvdScan,
            ...
            children: [
              ...
              Expanded(
                child: Obx(() => ElevatedButton(
                      onPressed: controller.isFvdScanDone.value ||
                              controller.fvdScannedBarcode.value.isNotEmpty
                          ? controller.nextFvdStep
                          : null,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.primary,
                        foregroundColor: Colors.white,
